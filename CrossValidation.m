...
if exist('f') == 0,
    ...
    data(14,:) = {'2-5', 829, 849};
    data(15,:) = {'2-6', 885, 908};
    data(16,:) = {'3-1', 1019, 1034};
    data(17,:) = {'3-2', 1070, 1086};
    data(18,:) = {'3-3', 1123, 1140};
    data(19,:) = {'3-4', 1174, 1191};
    data(20,:) = {'3-5', 1226, 1242};
    data(21,:) = {'3-6', 1279, 1295};
    data(22,:) = {'3-7', 1567, 1586};
    data(23,:) = {'3-8', 1622, 1639};
    data(24,:) = {'3-9', 1676, 1694};
...
for index=1:8,
    ...
    class1(end+1) = Classify(classify_data(1), 3, means, invcors, M, aprioris);
    class2(end+1) = Classify(classify_data(2), 3, means, invcors, M, aprioris);
